...
export function SignupForm({
  ...
  return (
    <Form onChange={handleChange} noValidate>
      <Form.Row>
        <Col xs={12} md={6}>
          <Form.Group>
      ...
      <Form.Group>
        ...
        <Form.Control
          required
          isValid={formData.phoneNumber && errors.phoneNumber.length === 0}
          isInvalid={formData.phoneNumber && errors.phoneNumber.length > 0}
          name="phoneNumber"
          id="phoneNumber"
          type="text"
      ...
      {!anonymus ? (
          ...
          <Form.Row>
            <Col xs={12} md={6}>
              <Form.Group>
                ...
                />
                <small>
                  Le mot de passe doit contenir 8 caractères dont une lettre et
                  un chiffre.
                </small>
              </Form.Group>
            </Col>
        ...
        <>
          <Form.Group>
            <Form.Label>Message (optionel)</Form.Label>
            <Form.Control
